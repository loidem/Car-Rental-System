	...
	<div class="col-xs-12 col-md-5">
		...
		<legend>Personal Information</legend>
			...
			echo form_label('Initials', 'first_name');
			echo form_input(array('name' => 'first_name', 'class' => 'form-control', 'value' => set_value('first_name'), 'placeholder' => 'Initials', 'required' => 'required', 'autofocus' => 'autofocus'));
			echo '<br>';
			...
			echo form_input(array('name' => 'street', 'class' => 'form-control', 'value' => set_value('street'), 'placeholder' => 'Street', 'required' => 'required'));
			echo '<br>';
			echo form_label('City', 'city');
			echo form_input(array('name' => 'city', 'class' => 'form-control', 'value' => set_value('city'), 'placeholder' => 'City', 'required' => 'required'));
			echo '<br>';
		
			echo form_label('State', 'state');
			echo form_input(array('name' => 'state', 'class' => 'form-control', 'value' => set_value('state'), 'placeholder' => 'State', 'required' => 'required'));
			echo '<br>';
			
			echo form_label('Zipcode', 'zip');
			echo form_input(array('name' => 'zip', 'class' => 'form-control', 'value' => set_value('zip'), 'placeholder' => 'Zipcode', 'required' => 'required'));
			echo '<br>';
			echo form_label('Phone', 'phone');
			echo form_input(array('name' => 'phone', 'class' => 'form-control', 'value' => set_value('phone'), 'placeholder' => 'Phone', 'required' => 'required'));
			echo '<br>';
