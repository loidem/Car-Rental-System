...
<html lang="en">
 	<head>
	    ...
	    <link href="http://localhost/crsys/public/css/custom.css" rel="stylesheet">
	    <!-- Datapicker -->
	    <link href="http://localhost/crsys/public/css/datepicker.css" rel="stylesheet">
	    <!-- Font Awesome -->
						...
						<?php 
							...
							else if ($session && $accounttype == 'user')
							{
								echo "
									<li><a href='" . base_url() . "profile'><i class='fa fa-user fa-lg'></i> Dashboard</a></li>
									<li><a href='" . base_url() . "gallery'><i class='fa fa-archive fa-lg'></i> Gallery</a></li>
									<li><a href='" . base_url() . "profile/schedule'><i class='fa fa-archive fa-lg'></i> Schedule</a></li>
									";
							}
						?>
						<!--
